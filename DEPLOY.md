...
- `schema.sql` — таблиці повідомлень і випусків;
...
Опитування «зрада чи перемога» в першу версію не входять — додамо, коли вижимки стабільно працюватимуть (`poll.js` уже готовий).
...
4. Перший вечірній випуск о 22:00, обідній о 13:00 — якщо набралось ≥ 100 повідомлень; вечірній — якщо ≥ 50, інакше повідомлення переходять у наступний випуск.

Опитування «зрада чи перемога» вмикаємо окремо, після кількох днів стабільних вижимок.
